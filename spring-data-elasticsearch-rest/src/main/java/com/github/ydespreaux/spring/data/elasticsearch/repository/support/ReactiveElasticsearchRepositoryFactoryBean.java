 ...
 * @since 1.0.0
 */
public class ReactiveElasticsearchRepositoryFactoryBean<T extends Repository<S, K>, S, K extends Serializable> extends
    ...
    /**
     * Configures the {@link ReactiveElasticsearchOperations} to be used to create Elasticsearch repositories.
     *
     * @param operations the operations to set
     */
    public void setElasticsearchOperations(ReactiveElasticsearchOperations operations) {

        Assert.notNull(operations, "ReactiveElasticsearchOperations must not be null!");
    ...
    public void afterPropertiesSet() {
        ...
        Assert.notNull(operations, "ReactiveElasticsearchOperations must be configured!");
    }
