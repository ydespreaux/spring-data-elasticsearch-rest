...
public @interface EnableReactiveElasticsearchRepositories {
     ...
     * Defaults to {@link ReactiveElasticsearchRepositoryFactoryBean}.
     *
    ...
    /**
     * Configures the name of the {@link ReactiveElasticsearchTemplate} bean definition to be used to create repositories
     * discovered through this annotation. Defaults to {@code elasticsearchTemplate}.
     *
     * @return bean name for elasticsearch template
     */
    String reactiveElasticsearchTemplateRef() default "reactiveRestElasticsearchTemplate";
