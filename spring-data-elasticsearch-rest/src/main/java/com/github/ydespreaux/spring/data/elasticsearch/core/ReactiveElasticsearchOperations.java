...
//     */
//    Mono<Boolean> createIndex(String indexName);
//
//    /**
//     * @param indexName the index name
...
//     */
//    <T> Flux<T> bulkIndex(List<T> entities, Class<T> clazz);
//
//    /**
//     * @param entities  all entities to index
//     * @return the entities indexed
//     */
//    Flux<?> bulkIndex(List<?> entities);
//
...
//     * @param <T>      method generic.
//     */
//    <T> Mono<Void> deleteAll(List<T> entities, Class<T> clazz);
//
//    /**
...
//     */
//    <T> Flux<T> search(SearchQuery search, Class<T> clazz);
//
//    /**
//     *
//     * @param search
...
//     * @return
//     */
//    <T> Flux<T> search(CriteriaQuery search, Class<T> clazz);
//
//    /**
//     * @param stringQuery
//     * @param clazz
...
//     * @return
//     */
//    <T> Flux<T> search(StringQuery stringQuery, Class<T> clazz);
//
//    /**
//     * @param query
...
//     * @return
//     */
//    <T> Flux<T> search(SearchQuery query, ResultsExtractor<T> resultsExtractor);
//
//    /**
//     * @param suggestion
//     * @param indices
