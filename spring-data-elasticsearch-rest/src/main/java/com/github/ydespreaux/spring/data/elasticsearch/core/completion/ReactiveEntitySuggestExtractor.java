 ...
 * @since 1.0.0
 */
public class ReactiveEntitySuggestExtractor<T> implements ResultsExtractor<Flux<T>> {

    private final Class<T> entityType;
    private final ResultsMapper mapper;

    public ReactiveEntitySuggestExtractor(Class<T> entityType, ResultsMapper mapper) {
        this.entityType = entityType;
        this.mapper = mapper;
    }

    @Override
    public Flux<T> extract(SearchResponse response) {
