...
@SpringBootTest(classes = {
        ...
        ReactiveElasticsearchTemplateMappingTest.ElasticsearchConfiguration.class})
@Profile("test-no-template")
@Testcontainers
public class ReactiveElasticsearchTemplateMappingTest {
    ...
    @EnableReactiveElasticsearchRepositories(
            basePackages = {
                    "com.github.ydespreaux.spring.data.elasticsearch.reactive.repositories.template",
                    "com.github.ydespreaux.spring.data.elasticsearch.reactive.repositories.synonyms",
            },
